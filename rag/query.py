...
from rag.config import GROQ_API_KEY, QDRANT_API_KEY, QDRANT_URL, QUERYING_MODEL
...
"""
        ...
        logger.exception(f"Some Error Ocurred in querying: {question}")
        raise RuntimeError('Query pipeline failed')
...
def _handle_chitchat(question: str, api_key: str | None = None) -> str:
    """
